...
class RestClient {
  ...
  constructor (apiKey, apiSecret, options = {}) {
    ...
    this.#options = Object.assign({
      ...
      host: 'https://trade.cex.io/api/margin/'
    }, _options)
  ...
  callPublic (action, params = {}) {
    const headers = {
      ...
      'User-Agent': 'CEX.IO Margin Trading Node Client'
    }
